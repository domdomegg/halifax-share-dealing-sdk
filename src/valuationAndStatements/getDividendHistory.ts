...
export default (config: Config) => ({ accountId }: Accounty): Promise<Dividend[]> => request(`${urlBuilder(config).generateSD('sdaccountdividendstatement', accountId)}&ChosenStartMonth=1&ChosenStartYear=2005&ChosenEndMonth=12&ChosenEndYear=3000`)
